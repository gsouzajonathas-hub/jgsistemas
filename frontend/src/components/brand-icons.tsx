...
/* Ícones extras para a landing page ----------------------------------- */
...
export function IconTicket(props: IconProps) {
  return (
    <Base {...props}>
      ...
      <path d="M13.5 9v.01M13.5 15v.01M9.5 9v.01M9.5 15v.01" />
    </Base>
  );
}
...
export function IconFileSignature(props: IconProps) {
  return (
    <Base {...props}>
      <path d="M14 3.5H6a1 1 0 0 0-1 1V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7.5l-5-4Z" />
      <path d="M14 3.5v4h4" />
      <path d="m7.5 16.5 1.8-.5 4.4-4.4a1 1 0 0 0 0-1.4l-.4-.4a1 1 0 0 0-1.4 0l-4.4 4.4-.5 1.8Z" />
      <path d="M15 20h3" />
    </Base>
  );
}
